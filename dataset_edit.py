...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        with open(osp.join("./processed_dataset/",self.mode,'annotation', 'capture'+str(capture_id)+'/cam'+str(cam)+'/frame'+str(frame_idx)+'.pkl'), 'rb') as file:
            ...
            elif input_msk.shape[-1] == 4:
                input_msk = (input_msk[...,-1] < 0.5).astype(np.uint8)
        ...
        # intrinsic_normed_cond = torch.as_tensor(
        #         [
        #             [346.1822,   0.0000, 126.0000],                                                                                                                                                                                              
        #             [  0.0000, 346.1822, 126.0000],                                                                                                                                                                                              
