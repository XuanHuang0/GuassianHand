...
class TGS(torch.nn.Module, SaverMixin):
    ...
    class Config:
        ...
        render_edit: dict = field(default_factory=dict)
    ...
    def __init__(self, cfg):
        ...
        self.render_edit = self.cfg.render_edit
    ...
    def _forward(self, batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        identity_code = self.identity_code_book.to(capture_id.device)[capture_id,:]
...
class HandLightningModule(pytorch_lightning.LightningModule):
    ...
    def test_step(self, batch, batch_nb):
        ...
        cv2.imwrite(os.path.join(render_dir, f'frame{frame_index}_view{view_index}_pred.png'), (rgb_pred[..., [2, 1, 0]]*255))
...
if __name__ == "__main__":
    ...
    from dataset_edit import Dataset, load_cfg
